...
# automatically add ssh keys to ssh-agent on boot (https://github.com/jirsbek/SSH-keys-in-macOS-Sierra-keychain)
cp ./prefs/ssh.add.a.plist ~/Library/LaunchAgents
...
# Install node stuffs
npm install -g yarnpkg yarn@0.17.10 bower cordova firebase gulp ionic phantomjs-prebuilt
